...
let emojiDir='';
if(emoji_count_recent>=2) emojiDir+='En este mensaje no uses emoji. ';
else if(emoji_count_recent===0) emojiDir+='Puedes usar 1 emoji suave al final si pega. ';
else emojiDir+='Si pega, usa como mucho 1 emoji. ';
